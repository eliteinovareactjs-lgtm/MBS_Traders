...
function OurJourney() {
  return (
    <section
      id="journey"
      className="w-full min-h-[700px] bg-[#A6AD91] px-6 md:px-[65px] lg:px-[5%] py-16 md:py-20 flex items-center font-body overflow-hidden"
    >
          ...
          <div className="bg-white rounded-[18px] shadow-[0_10px_35px_rgba(0,0,0,0.08)] px-8 md:px-[51px] py-8 md:py-[31px] min-h-[584px]">
            ...
            <ul className="space-y-[5px]">
              {missionPoints.map((point, i) => (
                <li
                  key={i}
                  className="flex items-start gap-[9px] text-[15px] md:text-[16px] text-[#444] leading-[1.8]"
                >
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Very light overlay to make the background faded */}
        ...
        <div className="space-y-8">
          ...
          {certifications.map((cert, i) => (
            <motion.div
              ...
              /* COME ONLY FROM BOTTOM */
              initial={{
                opacity: 0,
                y: 100,
              }}

              /* MOVE UP INTO NORMAL POSITION */
              whileInView={{
                opacity: 1,
                y: 0,
              }}
              ...
              /*
                Animation repeats when scrolling.
                The card starts below and comes upward.
              */
              viewport={{
                once: false,
                amount: 0.2,
              ...
              >
                ...
                <a
                  ...
                  className="
                    ...
                    transition-all
                    duration-200
                    hover:shadow-[0_5px_15px_rgba(8,123,245,0.25)]
                    active:scale-[0.97]
                  "
                >
                  Download PDF
...
const values = [
  {
    ...
    text: "Focused on meeting your evolving needs",
  },
  {
    label: "Safety",
    text: "Ensuring hygiene and compliance at every step",
  },
  {
    label: "Quality",
    text: "Only the best reaches your doorstep.",
  },
  {
    label: "Transparency",
    text: "We maintain full traceability from farm to home.",
  },
  {
    label: "Commitment",
    text: "Your health and satisfaction are our priority.",
  },
  {
    label: "Innovation",
    text: "Constantly improving our standards and delivery.",
  },
];
